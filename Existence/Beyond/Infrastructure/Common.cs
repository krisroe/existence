...
namespace Existence.Beyond.Infrastructure
{
    ...
    public enum SinType
    {
        ...
        Disorder,
        Disrespect,
        DisrespectOfReligion,
        Disruption,
        DoingWhatYouThinkYoureSupposedToDo,
        Domination,
        ...
        FlippantRemarks,
        ForgettingImportantInformation,
        Fraud,
        Ghosting,
        GivingUp,
        Gluttony,
        ...
        InappropriateUseOfTherapy,
        Inattention,
        Incompetence,
        InducingDangerousBehavior,
        IneffectiveCommunicationOfPoliticalViews,
        ...
        Lie,
        MakingAMess,
        MisinterpretingInternalFeelings,
        MisplacedBelongings,
