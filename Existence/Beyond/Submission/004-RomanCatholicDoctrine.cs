...
namespace Existence.Beyond.Submission
{
    ...
    internal class CatholicDoctrineSubmission : SubmissionBase
    {
        internal override List<LevelJustification> GetLevelJustifications()
        {
            ...
            {
                new DocumentationJustification("Roman Catholic Councils"),
                new DocumentationJustification("Roman Catholic Doctrine")
            };
        }
        internal override List<TimelessChange>? GetTimelessChanges()
        {
            ...
            {
                new TimelessChange("Earth Primary Calendars"),
                new TimelessChange("Earth Time Waypoints")
            };
        }
    }
    ...
    public class ChristianityTimeline
    {
        ...
        public ChristianityTimeline()
        {
            ...
            //some doctrine doesn't have a specific point in time created before the East-West schism
            //so it's added in here.
