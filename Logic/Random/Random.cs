...
public static class Logic
{
 ...
 /// </summary>
 private static readonly ThreadLocal<Random> ThreadLocalRandomNew = new(() => new Random());
 ...
 public static IList<T> DoFisherYatesKnuthRandomizer<T>(IList<T> list, Random? r, RandomType rt, LinqHandling lh)
 {
  ...
  {
   RandomType.New => new Random(),
   RandomType.Global => GlobalRandom,
   RandomType.RandomShared => Random.Shared,
